...
## Always use TranslationManager instead of Godot's TranslationServer or GEL - Godot Easy Localization won't work.
...
var language: StringName = LocalizationHelper.get_setting("language/default_lang", &"en") : set = set_language, get = get_language
